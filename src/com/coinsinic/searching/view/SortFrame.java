...
public class SortFrame extends JFrame {
    ...
    public SortFrame(String title,int canvasWidth,int canvasHeight,SelectionSortData data){
        super(title);
        ...
        JMenu instructionMenu = new JMenu("说明");
    ...
    //表格数据可视化
    //表格数据更新
    private void setDataTableData(SelectionSortData data){
        this.data=data;
